...
env.remote_dir = "/home/taylan/sites/insidermarketing"
env.hosts = [
    "67.23.4.212",
]
...
def deploy():
    ...
    with cd(env.remote_dir):
        ...
        with cd("deploy/insider_marketing"):
    ...
    # Sync the database
    run("cd %(remote_dir)s/app/insider_marketing; export PYTHONPATH=../lib; ./manage.py syncdb" % env)
